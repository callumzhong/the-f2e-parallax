...
export default function Clouds({ children }) {
  return (
    <>
      <div className="cloud-left absolute bottom-[4.3125rem] -z-10 w-screen overflow-hidden md:bottom-[2.5625rem] xl:inset-x-0 xl:bottom-auto xl:mx-auto xl:-mt-[3.0625rem]">
        <img
      ...
      <div className="cloud-right absolute bottom-[4.3125rem] -z-10  w-screen  overflow-hidden md:bottom-[3.615rem] xl:inset-x-0 xl:bottom-auto xl:mx-auto xl:-mt-[1.0625rem]">
        <img
